export default function SettingsPage() {
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 max-w-2xl space-y-5">
      ...
      <p className="text-xs text-slate-400 pt-2 border-t border-slate-100">HR accounts, email settings, and backups connect once the Node/Express backend is in place.</p>
    </div>
  );
}
